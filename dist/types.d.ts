...
export declare enum OpenAIModerationsModel {
    TextModerationStable = "text-moderation-stable",
    TextModerationLatest = "text-moderation-latest"
}
export declare enum AnthropicChatCompletionsModel {
    Claude1 = "claude-1",
    ClaudeInstant1 = "claude-instant-1",
    Claude2 = "claude-2"
}
export declare enum GoogleCompletionsModel {
    Bard = "bard"
}
export declare enum HuggingFaceDocumentsAskModel {
    LayoutlmDocumentQA = "layoutlm-document-qa"
}
export declare enum LlamaChatCompletionsModel {
    'Llama 2 7b Chat' = "llama-2-7b-chat",
    'Llama 2 13b Chat' = "llama-2-13b-chat",
    'Llama 2 70b Chat' = "llama-2-70b-chat"
}
export declare enum OraCompletionsModel {
    'GPT-3.5 Turbo' = "gpt-3.5-turbo"
}
export declare enum SberbankImagesGenerationsModel {
    Kandinsky = "kandinsky"
}
...
export declare enum OpenAIChatCompletionsMessageRole {
    System = "system",
    User = "user",
    Assistant = "assistant",
    Function = "function"
